...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/20 16:57:13 by rsaueia-          #+#    #+#             */
/*   Updated: 2024/04/02 19:45:54 by rsaueia-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	perror("Malloc has incurred in an unexpected error. \
	Please refrain from pursuing process.");
	exit(EXIT_FAILURE);
}
...
static void	data_init(t_fractal *fractal)
{
	...
	fractal->iterations_definition = 62;
	fractal->shift_x = 0.0;
	fractal->shift_y = 0.0;
	fractal->zoom = 1.0;
}
